...
module.exports = (paths, _opts, context) => {
  ...
  const hasOperationsList = paths['/v1/operations'] && 
                           paths['/v1/operations'].get;
  const hasOperationsGet = paths['/v1/operations/{operation}'] && 
                          paths['/v1/operations/{operation}'].get;
