...
beforeAll(async () => {
  linter = await linterForAepRule('0132', 'aep-132-request-field-types');
  return linter;
});

test('aep-132-request-field-types should find errors', () => {
  const oasDoc = {
    openapi: '3.0.3',
    paths: {
      '/test1': {
...
test('aep-132-request-field-types should find no errors', () => {
  const oasDoc = {
    openapi: '3.0.3',
    paths: {
      '/test1': {
